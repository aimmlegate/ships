...
export const MEDIA_PATH_ = "https://glossary-wows-global.gcdn.co/icons/";
export const VEHICLES_PATH_ =
  "https://vortex.worldofwarships.eu/api/encyclopedia/en/vehicles/";
export const NATIONS_PATH_ =
  "https://vortex.worldofwarships.eu/api/encyclopedia/en/nations/";
export const VEHICLES_TYPES_PATH_ =
...
export const VEHICLES_PATH =
  "hhttps://res.cloudinary.com/doneqwi7x/raw/upload/v1680287086/ships/vehicles.json";
export const NATIONS_PATH =
